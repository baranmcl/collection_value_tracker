# collection_value_tracker — Implementation Pitfalls & Review Findings

> **Purpose:** Document implementation traps, design flaws, and corrected decisions that would cause production failures, security vulnerabilities, or data correctness bugs if shipped. This document is the primary code review reference for the collection_value_tracker codebase.
>
...
>
> **Last validated against codebase:** 2026-05-20 (replace when you audit against the current code)
...
| CVT-1 | Money is integer cents | CRITICAL | UNIMPLEMENTED | Money |
| CVT-2 | Prices are estimates, not facts | HIGH | UNIMPLEMENTED | UI/Pricing |
| CVT-3 | The catalog is never bulk-priced | HIGH | UNIMPLEMENTED | Pricing |
